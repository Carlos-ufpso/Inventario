...
public class Inventario {
    // Se crea unas constantes para el menú
    ...
    public static void main(String[] args) {
        ...
        // Se crea variables para almacenar datos de productos
        ArrayList<String> productos = new ArrayList<>();
        ArrayList<Integer> cantidades = new ArrayList<>();
        ArrayList<Double> precios = new ArrayList<>();

        // Se hace un bucle donde muestre un menú para interactuar con el inventario
        String opcion;
        do {
            // Se hace un menú de opciones
            System.out.println("\nMenú de Inventario:");
    ...
    // Esta la función para agregar un nuevo producto
    ...
    // Esta es la función para eliminar un producto
    ...
    // Esta es la función para modificar un producto
    ...
    // Esta es la función para mostrar el inventario completo en formato de tabla
    private static void mostrarInventario(ArrayList<String> productos, ArrayList<Integer> cantidades, ArrayList<Double> precios) {
        ...
        // Aca es para mostrar como va ser la tabla del inventario
